  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-background dark:bg-background px-4 md:px-6">
      ...
      {result?.winners && result.winners.length > 0 && (
        <BackgroundLines className="absolute inset-0 flex items-center justify-center opacity-40 z-[-1]" svgOptions={{ duration: 12 }} children={undefined} />
      )}
      ...
      >
        {loading ? (
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center w-full gap-6 md:gap-16">
            ...
            >
              <SparklesText text="🚔 The Fugitive was Captured!" className="text-lg md:text-2xl lg:text-3xl font-bold text-emerald-500" />
              ...
              <div className="mt-4 flex items-center justify-center">
                <Image src="/gifs/caught.gif" alt="Fugitive Caught" width={140} height={90} className="rounded-lg shadow-lg" />
              </div>
            </motion.div>
            ...
            <div className="hidden md:flex justify-center items-center">
              ...
              >
                <Image src="/cops/fugitive.png" alt="Criminal" layout="fill" objectFit="cover" className="rounded-xl" />
              </motion.div>
            </div>
          </div>
        ) : (
