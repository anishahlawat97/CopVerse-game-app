...
export function VehicleSelectionList() {
  ...
  return (
    <div className="p-6 flex flex-col items-center justify-center min-h-screen text-center animate-fade-in">
              ...
              <div key={cityId} className="mb-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {vehicles.map((vehicle) => {
                    ...
                    const isInsufficientRange = vehicle.range < (cities.find(c => c.id === cityId)?.distance ?? 0) * 2;
                    ...
                    return (
                      ...
                      >
                        <Image src={vehicle.imageUrl} alt={vehicle.type} fill className="object-cover absolute inset-0" />
      ...
      <button onClick={handleSubmit} className="mt-6 px-6 py-3 bg-emerald-500 text-white rounded-lg">
