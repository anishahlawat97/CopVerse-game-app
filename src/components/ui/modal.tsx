...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, header, children, containerClass }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div
        className={`relative min-w-[90vw] md:min-w-[40vw] min-h-[25vh] bg-white dark:bg-black rounded-lg p-4 border border-gray-300 dark:border-gray-700 transition-opacity duration-300 ${containerClass}`}
      >
